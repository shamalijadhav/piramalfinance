import { branchInput, cutomerEmployment, cutomerIncome, cutomerName, cutomerNo, formDobInput, formLoanAmt, formTc, loanFormContainer, loanFormOtpBtn, loanOtpInput, loanProduct, otpNumChange, otpPhoneNum, stateInput } from "./loanformdom";
import { loanTypeDropdownSelect } from "./utm";
// export { formOpen };  
