                                ...
                                <div class="cmp-form-text">
                                    ...
                                    <div class="option-form-parent">
                                        <div class="option-form loan-form-drpdown">
                                            <sly data-sly-list.multiselect="${resource.children}">
                                                <sly data-sly-test="${multiselect.name == 'multiselectorul'}">
                                                    <sly data-sly-list.listitem="${multiselect.children}">
                                                        <ul>
                                                            <sly data-sly-list.multiselectli="${listitem.children}">
                                                                <sly data-sly-test="${multiselectli.name == 'multiselectorli'}">
                                                                    <sly data-sly-list.listitemtwo="${multiselectli.children}">
                                                                        <li class="subpoints" data-loan-type="${listitemtwo.loantype}" data-get-input="form-loan-type">${listitemtwo.liText}</li>
                                                                    </sly>
                                                                </sly>
                                                            </sly>
                                                        </ul>
