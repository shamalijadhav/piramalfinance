...
export function generateTeaserDOM(props, classes) {
  ...
  const [pictureBgContainer, pictureContainer, eyebrow, title, longDescr, shortDescr, firstCta, secondCta, ctaImage, ctaImageAlt, ctaImageUrl, ctaImage2, ctaImageAlt2, ctaImageUrl2, ctaImage3, ctaImageAlt3, ctaImageUrl3] = props;
